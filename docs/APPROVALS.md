...
| glyph | shown | change |
| --- | --- | --- |
| **ж** | 2026-08-06 | The same change as Ж, which is approved — one constant serves both cases through `lc()`. Built measurement 1.02–1.04 of an arm, inside the panel at all four weights. The capital was the one named, so this half is still in review. Same marginal on the arm: 0.85 and 0.84 at Bold and ExtraBold against brackets ending at 0.83 and 0.82. |
