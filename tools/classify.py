...
TIERS = [
    ...
    (0x041A, "Ka-cy", 2, "K's arm and leg, one vertex at Ж's waist"),
    ...
    # ---- lowercase -----------------------------------------------------
    (0x0430, "a-cy", 1, "a"),
    (0x0431, "be-cy", 2, "b, with a branch rising off its spine to the right"),
    ...
    (0x043A, "ka-cy", 2, "k's arm and leg, one vertex at ж's waist"),
